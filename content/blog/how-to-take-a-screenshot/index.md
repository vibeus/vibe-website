...
With every new piece of tech equipment we invest in, the search query becomes even more inevitable: how do I take a screenshot on this? The brief click of a button, or even the sound of our voice, lets us grab any image that meets our screen. A time-saving and versatile feature, knowing how to take a screenshot is a must for our visual world.
...
Being able to take a simple screenshot opens the door to a multitude of benefits. Whether you use this function for work, school, travel, or your personal life, taking a screenshot is a super handy trick. Here are some of the ways that a screenshot can help you out:
...
Almost every device is capable of helping you take a screenshot for these purposes and more. Learn how you can take a screenshot on each of your devices using these simple techniques.
...
**Capture a portion of the screen:** Press Command+Shift+4 to transform the cursor into a crosshair that you can use to select the screen area you want to capture. 
...
**Capture a window or menu on the screen:** This method gives you a screenshot of the entire screen. If you want to just capture an image of the current window you have open, without the interference of other images or browsers, press and hold Alt+Print Screen. 
...
Chromebook users can use the Show Windows button to capture a screenshot. Find this button on the top-middle of the keyboard — it’s the one with an image of a box and two horizontal lines. Take a full-screen screenshot by pressing Ctrl and then the Show Windows button (***Ctrl+Show Windows***). 
